 ...
 *			         Variables (Global)
 ************************************************************************/
struct sLED grnLED = {.Toggle = {.port = LED_GREEN_PORT, .pin = LED_GREEN_PIN, .mode = 0, .configured = 0, .inputValue = 0, .pullups = 1, .interrupt = 0, .interruptEdge = 0, .inverted = 0},
                      .State = LED_OFF_STATE,
                      .Count = 0,
                      .Flag = 0,
...
struct sLED redLED = {.Toggle = {.port = LED_RED_PORT, .pin = LED_RED_PIN, .mode = 0, .configured = 0, .inputValue = 0, .pullups = 1, .interrupt = 0, .interruptEdge = 0, .inverted = 0},
                      .State = LED_OFF_STATE,
                      .Count = 0,
                      .Flag = 0,
                      .Out = {LED_OFF, 0x0000000, 0, 0},
